...
bot = telebot.TeleBot('6436450622:AAFVRK-Ww1U09yYjF3SWTgTfkWI-AKbSvb4')
...
def start_attack(user_id, target, port, time):
    ...
    try:
        ...
        response = f"Brother enjoy 👌. Target: {target} Port: {port} Time: {time} 130"
...
def run_attack_and_notify(message, user_id, target, port, time):
    ...
    if success:
        ...
        bot.reply_to(message, " ✨ I AM FREE NOW 🙂 For Using type /bgmi1")
...
def handle_bgmi1(message):
    ...
    if user_id in allowed_user_ids:
        ...
        response = "🚫 Unauthorized Access! 🚫\n\nOops! It seems like you don't have permission to use the /bgmi1 command. DM TO BUY ACCESS:- @kaushik_oo7"
